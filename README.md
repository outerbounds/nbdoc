...
You have to pair `nbdoc` with a static site generator for it to be useful.  We have tested `nbdoc` extensively with [Docusaurus](https://docusaurus.io/) and have a [reference implementation of both working together here](https://github.com/outerbounds/nbdoc-docusaurus) that you can use.
